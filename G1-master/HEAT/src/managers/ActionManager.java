...
import com.sumit.playjava.TextToSpeech;
...
public class ActionManager {
  ...
  public static boolean useLargeIcon = true;

  /* Static instantiation of our custom Actions */
  
  // file/program actions
  private TextToSpeechAction textToSpeechAction = new TextToSpeechAction("Text to Speech",
	  Resources.getIcon("tts16"), "Convert text to speech", 
	  KeyEvent.VK_M, KeyStroke.getKeyStroke(KeyEvent.VK_M, Toolkit.getDefaultToolkit().getMenuShortcutKeyMask(), false));
  private TextToSpeechAction toolbarTextToSpeechAction = new TextToSpeechAction(null,
	  Resources.getIcon("tts22"), "Convert text to speech", 
	  KeyEvent.VK_M, KeyStroke.getKeyStroke(KeyEvent.VK_M, Toolkit.getDefaultToolkit().getMenuShortcutKeyMask(), false));
  private TextToSpeechAction2 textToSpeechAction2 = new TextToSpeechAction2("Read Line",
	  Resources.getIcon("ttsl16"), "Read out current line",
	  KeyEvent.VK_N, KeyStroke.getKeyStroke(KeyEvent.VK_N, Toolkit.getDefaultToolkit().getMenuShortcutKeyMask(), false));
  private TextToSpeechAction2 toolbarTextToSpeechAction2 = new TextToSpeechAction2(null,
	  Resources.getIcon("ttsl22"), "Read out current line",
	  KeyEvent.VK_N, KeyStroke.getKeyStroke(KeyEvent.VK_N, Toolkit.getDefaultToolkit().getMenuShortcutKeyMask(), false));
  private TextToSpeechShutUpAction textToSpeechShutUpAction = new TextToSpeechShutUpAction("Shut up TTS",
	  Resources.getIcon("shh16"), "Terminate Text-to-speech",
	  KeyEvent.VK_N, KeyStroke.getKeyStroke(KeyEvent.VK_N, Toolkit.getDefaultToolkit().getMenuShortcutKeyMask(), false));
	  private TextToSpeechShutUpAction toolbarTextToSpeechShutUpAction = new TextToSpeechShutUpAction(null,
	  Resources.getIcon("shh22"), "Terminate Text-to-speech",
	  KeyEvent.VK_N, KeyStroke.getKeyStroke(KeyEvent.VK_N, Toolkit.getDefaultToolkit().getMenuShortcutKeyMask(), false));
	  private ExitProgramAction exitProgramAction = new ExitProgramAction("Quit",
		      useLargeIcon ? Resources.getIconLarge("exit16", 150) : Resources.getIcon("exit16"), "Quit HEAT", new Integer(KeyEvent.VK_Q),
		  ...
		  private ExitProgramAction toolbarExitProgramAction = new ExitProgramAction(null,
			  useLargeIcon ? Resources.getIconLarge("exit22", 150) : Resources.getIcon("exit22"), "Quit HEAT", new Integer(KeyEvent.VK_Q),
		      KeyStroke.getKeyStroke(KeyEvent.VK_Q, java.awt.Toolkit.getDefaultToolkit().getMenuShortcutKeyMask(), false));
		  
		  private OpenFileAction openFileAction = new OpenFileAction("Open..",
			  useLargeIcon ? Resources.getIconLarge("fileopen16", 150) : Resources.getIcon("fileopen16"), "Open an existing or new file in the editor",
		  ...
		  private OpenFileAction toolbarOpenFileAction = new OpenFileAction(null,
				  useLargeIcon ? Resources.getIconLarge("fileopen22", 150) : Resources.getIcon("fileopen22"), "Open an existing or new file in the editor",
		      new Integer(KeyEvent.VK_O),
		      KeyStroke.getKeyStroke(KeyEvent.VK_O, java.awt.Toolkit.getDefaultToolkit().getMenuShortcutKeyMask(), false));
		  
		  private CloseFileAction closeFileAction = new CloseFileAction("Close",
				  useLargeIcon ? Resources.getIconLarge("fileclose16", 150) : Resources.getIcon("fileclose16"), "Save file and close editor", null, null);
		  
		  private CloseFileAction toolbarCloseFileAction = new CloseFileAction(null,
				  useLargeIcon ? Resources.getIconLarge("fileclose22", 150) : Resources.getIcon("fileclose22"), "Save file and close editor", null, null);
		  
		  private PrintFileAction printFileAction = new PrintFileAction("Print",
				  useLargeIcon ? Resources.getIconLarge("fileprint16", 150) : Resources.getIcon("fileprint16"), "Print editor content or interpreter console",
		  ...
		  private ShowOptionsAction showOptionsAction = new ShowOptionsAction("Options",
				  useLargeIcon ? Resources.getIconLarge("list16", 150) : Resources.getIcon("list16"), "Change HEAT Options",
		  ...
		  // editing actions
		  private UndoAction undoAction = new UndoAction("Undo", useLargeIcon ? Resources.getIconLarge("undo16", 150) : Resources.getIcon("undo16"),
		  ...
		  private UndoAction toolbarUndoAction = new UndoAction(null, useLargeIcon ? Resources.getIconLarge("undo22", 150) : Resources.getIcon("undo22"),
			      "Undo last change", new Integer(KeyEvent.VK_Z),
			      KeyStroke.getKeyStroke(KeyEvent.VK_Z, java.awt.Toolkit.getDefaultToolkit().getMenuShortcutKeyMask(), false));
		  private RedoAction redoAction = new RedoAction("Redo", useLargeIcon ? Resources.getIconLarge("redo16", 150) : Resources.getIcon("redo16"),
		  ...
		  private RedoAction toolbarRedoAction = new RedoAction(null, useLargeIcon ? Resources.getIconLarge("redo22", 150) : Resources.getIcon("redo22"),
			      "Redo last change", new Integer(KeyEvent.VK_Y),
			      KeyStroke.getKeyStroke(KeyEvent.VK_Y, java.awt.Toolkit.getDefaultToolkit().getMenuShortcutKeyMask(), false));
		  private ShowSearchAction showSearchAction = new ShowSearchAction("Find",
				  useLargeIcon ? Resources.getIconLarge("findfile16", 150) : Resources.getIcon("filefind16"), "Find text in the program",
		  ...
		  private ShowSearchAction toolbarSearchAction = new ShowSearchAction(null,
				  useLargeIcon ? Resources.getIconLarge("findfile22", 150) : Resources.getIcon("filefind22"), "Find text in the program",
			      new Integer(KeyEvent.VK_F),
			      KeyStroke.getKeyStroke(KeyEvent.VK_F, java.awt.Toolkit.getDefaultToolkit().getMenuShortcutKeyMask(), false));
		  private EditCutAction editCutAction = new EditCutAction("Cut",
				  useLargeIcon ? Resources.getIconLarge("editcut16", 150) : Resources.getIcon("editcut16"), "Cut selected text", new Integer(KeyEvent.VK_X),
		  ...
		  private EditCutAction toolbarEditCutAction = new EditCutAction(null,
				  useLargeIcon ? Resources.getIconLarge("editcut22", 150) : Resources.getIcon("editcut22"), "Cut selected text", new Integer(KeyEvent.VK_X),
			      KeyStroke.getKeyStroke(KeyEvent.VK_X, java.awt.Toolkit.getDefaultToolkit().getMenuShortcutKeyMask(), false));
		  private EditCopyAction editCopyAction = new EditCopyAction("Copy",
				  useLargeIcon ? Resources.getIconLarge("editcopy16", 150) : Resources.getIcon("editcopy16"), "Copy selected text", new Integer(KeyEvent.VK_C),
		  ...
		  private EditCopyAction toolbarEditCopyAction = new EditCopyAction(null,
				  useLargeIcon ? Resources.getIconLarge("editcopy22", 150) : Resources.getIcon("editcopy22"), "Copy selected text", new Integer(KeyEvent.VK_C),
			      KeyStroke.getKeyStroke(KeyEvent.VK_C, java.awt.Toolkit.getDefaultToolkit().getMenuShortcutKeyMask(), false));
		  private EditPasteAction editPasteAction = new EditPasteAction("Paste",
				  useLargeIcon ? Resources.getIconLarge("editpaste16", 150) : Resources.getIcon("editpaste16"), "Paste selected text", new Integer(KeyEvent.VK_V),
		  ...
		  private EditPasteAction toolbarEditPasteAction = new EditPasteAction(null,
				  useLargeIcon ? Resources.getIconLarge("editpaste22", 150) : Resources.getIcon("editpaste22"), "Paste selected text", new Integer(KeyEvent.VK_V),
			      KeyStroke.getKeyStroke(KeyEvent.VK_V, java.awt.Toolkit.getDefaultToolkit().getMenuShortcutKeyMask(), false));

		  // run actions
		  private CompileAction compileAction = new CompileAction(null,
				    useLargeIcon ? Resources.getIconLarge("reload16", 150) : Resources.getIcon("reload16"), "Load & compile program", new Integer(KeyEvent.VK_L),
		  ...
		  private CompileAction toolbarCompileAction = new CompileAction(null,
				    useLargeIcon ? Resources.getIconLarge("reload22", 150) : Resources.getIcon("reload22"), "Load program into interpreter and compile it", new Integer(KeyEvent.VK_L),
				    KeyStroke.getKeyStroke(KeyEvent.VK_L, java.awt.Toolkit.getDefaultToolkit().getMenuShortcutKeyMask(), false));
		  private InterruptAction interruptAction = new InterruptAction(null, 
				    useLargeIcon ? Resources.getIconLarge("stop16", 150) : Resources.getIcon("stop16"), "Interrupt interpreter", new Integer(KeyEvent.VK_I),
		  ...
		  private InterruptAction toolbarInterruptAction = new InterruptAction(null, 
				    useLargeIcon ? Resources.getIconLarge("stop22", 150) : Resources.getIcon("stop22"), "Interrupt interpreter", new Integer(KeyEvent.VK_I),
				    KeyStroke.getKeyStroke(KeyEvent.VK_I, java.awt.Toolkit.getDefaultToolkit().getMenuShortcutKeyMask(), false));
		  private TestAction testAction = new TestAction(null, 
				    useLargeIcon ? Resources.getIconLarge("debug16", 150) : Resources.getIcon("debug16"), "Check properties", new Integer(KeyEvent.VK_T),
		  ...
		  private TestAction toolbarTestAction = new TestAction(null, 
				    useLargeIcon ? Resources.getIconLarge("debug22", 150) : Resources.getIcon("debug22"), "Check properties", new Integer(KeyEvent.VK_T),
				    KeyStroke.getKeyStroke(KeyEvent.VK_T, java.awt.Toolkit.getDefaultToolkit().getMenuShortcutKeyMask(), false));

		  // help actions
		  private ShowHelpAction showHelpAction = new ShowHelpAction("Help",
				  useLargeIcon ? Resources.getIconLarge("help16", 150) : Resources.getIcon("help16"), "Display help", new Integer(KeyEvent.VK_L),
		  ...
		  private ShowAboutAction showAboutAction = new ShowAboutAction("About",
				  useLargeIcon ? Resources.getIconLarge("info16", 150) : Resources.getIcon("info16"), "Display about information", null, null);
		  

		  private RefreshTreeAction refreshTreeAction = new RefreshTreeAction("", useLargeIcon ? Resources.getIconLarge("reload16", 150) : Resources.getIcon("reload16"),
		           "Refresh overview");
		  private ExpandTreeAction expandTreeAction = new ExpandTreeAction("", useLargeIcon ? Resources.getIconLarge("expandTreeWindow16", 150) : Resources.getIcon("expandTreeWindow16"),
		           "Expand all overview elements");
		  private CollapseTreeAction collapseTreeAction = new CollapseTreeAction("", useLargeIcon ? Resources.getIconLarge("collapseTreeWindow16", 150) : Resources.getIcon("collapseTreeWindow16"),
		           "Collapse all overview elements");
		  private ToggleTreeAction toggleTreeAction = new ToggleTreeAction(null, useLargeIcon ? Resources.getIconLarge("tree_window_22", 150) : Resources.getIcon("tree_window_22"),
		      "Show/hide overview");
		  private ToggleConsoleAction toggleOutputAction = new ToggleConsoleAction(null, useLargeIcon ? Resources.getIconLarge("output_window_22", 150) : Resources.getIcon("output_window_22"),
		  ...
		  private SendEvaluationAction sendEvaluationAction = new SendEvaluationAction("Send",
				  useLargeIcon ? Resources.getIconLarge("effect16", 150) : Resources.getIcon("effect16"), "Sends Evaluation to Interpreter",
		  ...
		  public boolean isUseLargeIcon() {
		      return useLargeIcon;
		  }

		  public static void toggleUseLargeIcon() {
		  ...
		  public ActionManager.TextToSpeechAction getTextToSpeechProgramAction() {
			    return textToSpeechAction;
			  }
		  
		  public ActionManager.TextToSpeechAction2 getTextToSpeechProgramAction2() {
			    return textToSpeechAction2;
			  }
		  public ActionManager.TextToSpeechShutUpAction getTextToSpeechShutUpAction() {
			  return textToSpeechShutUpAction;
		  }
		  ...
		  public ActionManager.TextToSpeechAction getToolbarTextToSpeechProgramAction() {
			    return toolbarTextToSpeechAction;
		  }

		  
		  public ActionManager.TextToSpeechAction2 getToolbarTextToSpeechProgramAction2() {
			    return toolbarTextToSpeechAction2;
		  }
		  
		  public ActionManager.TextToSpeechShutUpAction getToolbarTextToSpeechShutUpAction() {
			  return toolbarTextToSpeechShutUpAction;
		  }
		  ...
		  private class TextToSpeechAction extends AbstractAction {
			    public TextToSpeechAction(String text, ImageIcon icon, String desc,
			                              Integer mnemonic, KeyStroke accelerator) {
			        super(text, icon);
			        putValue(SHORT_DESCRIPTION, desc);
			        putValue(MNEMONIC_KEY, mnemonic);
			    ...
			    public void actionPerformed(ActionEvent e) {
			        ...
			        if (consoleWindow != null) {
			            ...
			            JTextPane consolePane = consoleWindow.getTextPane();

			            
			            TextToSpeech textToSpeech = new TextToSpeech();
			            textToSpeech.readConsoleText(consolePane);
			        } else {
			            System.out.println("Error: ConsoleWindow not found.");
			        }
			    }
			}
		  
		  private class TextToSpeechAction2 extends AbstractAction {
			    public TextToSpeechAction2(String text, ImageIcon icon, String desc,
			                              Integer mnemonic, KeyStroke accelerator) {
			        super(text, icon);
			        putValue(SHORT_DESCRIPTION, desc);
			        putValue(MNEMONIC_KEY, mnemonic);
			    ...
			    public void actionPerformed(ActionEvent e) {
			        ...
			        if (consoleWindow != null) {
			            ...
			            TextToSpeech textToSpeech = new TextToSpeech();
			            textToSpeech.readConsoleLine(consolePane);
			        } else {
			            System.out.println("Error: ConsoleWindow not found.");
			        }
			    }
		  ...
		  private class TextToSpeechShutUpAction extends AbstractAction {
			    public TextToSpeechShutUpAction(String text, ImageIcon icon, String desc,
			                              Integer mnemonic, KeyStroke accelerator) {
			        super(text, icon);
			        putValue(SHORT_DESCRIPTION, desc);
			        putValue(MNEMONIC_KEY, mnemonic);
		  ...
		  public class RedoAction extends AbstractAction {
		   ...
		   protected class GoToRecentConsoleHistory extends AbstractAction{
		    ...
		    public void toggleUseLargeIcons() {
		    	if (!useLargeIcon ) {
		    		useLargeIcon = true;
		    	}
		    	else {
