...
public class MainMenu {
  ...
  public void jbInit() throws Exception {
    ...
    JMenuItem jMenuItemTextToSpeech = new JMenuItem("Text-to-speech");
    jMenuItemTextToSpeech.setAction(am.getTextToSpeechProgramAction());
    jMenuItemTextToSpeech.setMnemonic('m');
    jMenuItemTextToSpeech.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_M, InputEvent.CTRL_DOWN_MASK));
    jMenuHelp.add(jMenuItemTextToSpeech);

    JMenuItem jMenuItemReadLine = new JMenuItem("Read Line");
    jMenuItemReadLine.setAction(am.getToolbarTextToSpeechProgramAction2());
    jMenuItemReadLine.setMnemonic('n');
    jMenuItemReadLine.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_N, InputEvent.CTRL_DOWN_MASK));
    jMenuHelp.add(jMenuItemReadLine);
