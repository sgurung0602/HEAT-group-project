...
public class Toolbar {
  ...
  private JButton textToSpeech = new JButton(am.getToolbarTextToSpeechProgramAction());
  private JButton textToSpeech2 = new JButton(am.getToolbarTextToSpeechProgramAction2());
  private JButton shutUp = new JButton(am.getToolbarTextToSpeechShutUpAction());
  ...
  public void createToolbar() throws Exception {
    ...
    toolBar.add(textToSpeech);
    toolBar.add(textToSpeech2);
    toolBar.add(shutUp);
    toolBar.addSeparator();
